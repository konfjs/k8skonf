...
# TODO: Ennees dooshih neeh chuhal bish.
# TODO: Can I do this in the previous step? How can I figure this out?
...
# Ene ih uddag, end tend ni oruulj bairshuuldag chuhal alham.
# Requires "schemas.json"
.PHONY: move-core
move-core:
