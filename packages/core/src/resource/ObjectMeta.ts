...
export interface ObjectMeta {
     ...
     * for the responsible component that will remove the entry from the list.
     ...
     * If the finalizer list is processed in order, then this can lead to a situation in which the
     * component responsible for the first finalizer in the list is waiting for a signal
     * (field value, external system, or other) produced by a component responsible for a finalizer
     * later in the list, resulting in a deadlock. Without enforced ordering finalizers are free to
     ...
     * will be different than the name passed. This value will also be combined with a unique suffix.
     ...
     * an entry in this list will point to this controller, with the controller field set to true.
