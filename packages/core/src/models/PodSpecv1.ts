import { Affinityv1 } from './Affinityv1.js';
import { Containerv1 } from './Containerv1.js';
import { EphemeralContainerv1 } from './EphemeralContainerv1.js';
import { HostAliasv1 } from './HostAliasv1.js';
import { LocalObjectReferencev1 } from './LocalObjectReferencev1.js';
import { PodDNSConfigv1 } from './PodDNSConfigv1.js';
import { PodOSv1 } from './PodOSv1.js';
import { PodReadinessGatev1 } from './PodReadinessGatev1.js';
...
export interface PodSpecv1 {
   ...
   */
  ephemeralContainers?: Array<EphemeralContainerv1>;
  /**
   * HostAliases is an optional list of hosts and IPs that will be injected into the pod\'s hosts file if specified.
   */
  hostAliases?: Array<HostAliasv1>;
  /**
   ...
   */
  imagePullSecrets?: Array<LocalObjectReferencev1>;
  /**
   ...
   */
  initContainers?: Array<Containerv1>;
  /**
   ...
   */
  readinessGates?: Array<PodReadinessGatev1>;
  /**
   ...
   */
  schedulingGates?: Array<PodSchedulingGatev1>;
  /**
   ...
   */
  topologySpreadConstraints?: Array<TopologySpreadConstraintv1>;
  /**
   * List of volumes that can be mounted by containers belonging to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes
   */
  volumes?: Array<Volumev1>;
}
