...
import { V1PersistentVolumeClaim } from './V1PersistentVolumeClaim.js';
import { V1PodTemplateSpec } from './V1PodTemplateSpec.js';
import { V1StatefulSetOrdinals } from './V1StatefulSetOrdinals.js';
import { V1StatefulSetPersistentVolumeClaimRetentionPolicy } from './V1StatefulSetPersistentVolumeClaimRetentionPolicy.js';
import { V1StatefulSetUpdateStrategy } from './V1StatefulSetUpdateStrategy.js';
