...
import { V1EndpointPort } from './V1EndpointPort.js';
import { K8sApp } from '../K8sApp.js';
import { V1NamespacedObjectMeta, NamespacedApiObject } from '../ApiObject.js';

export interface V1EndpointSliceArgs {
  readonly addressType: string;
  readonly endpoints: Array<V1Endpoint>;
  readonly metadata?: V1NamespacedObjectMeta;
  readonly ports?: Array<V1EndpointPort>;
}

/**
 * EndpointSlice represents a subset of the endpoints that implement a service. For a given service there may be multiple EndpointSlice objects, selected by labels, which must be joined to produce the full set of endpoints.
 */
export class V1EndpointSlice extends NamespacedApiObject {
  /**
  ...
  constructor(app: K8sApp, name: string, args: V1EndpointSliceArgs) {
    super();
