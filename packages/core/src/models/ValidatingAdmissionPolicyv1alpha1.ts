...
import { ValidatingAdmissionPolicySpecv1alpha1 } from './ValidatingAdmissionPolicySpecv1alpha1.js';
import { K8sApp } from '../K8sApp.js';
import { ApiObject } from '../ApiObject.js';

export interface ValidatingAdmissionPolicyv1alpha1Args {
...
export class ValidatingAdmissionPolicyv1alpha1 extends ApiObject {
  ...
  constructor(app: K8sApp, name: string, args: ValidatingAdmissionPolicyv1alpha1Args) {
    super();
