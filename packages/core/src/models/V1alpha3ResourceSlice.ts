...
import { V1alpha3ResourceSliceSpec } from './V1alpha3ResourceSliceSpec.js';
import { K8sApp } from '../K8sApp.js';
import { ApiObject } from '../ApiObject.js';

export interface V1alpha3ResourceSliceArgs {
  readonly metadata?: V1ObjectMeta;
  readonly spec: V1alpha3ResourceSliceSpec;
}
 ...
 */
export class V1alpha3ResourceSlice extends ApiObject {
  /**
  ...
  constructor(app: K8sApp, name: string, args: V1alpha3ResourceSliceArgs) {
    super();
