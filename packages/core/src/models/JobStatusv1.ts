import { JobConditionv1 } from './JobConditionv1.js';
import { UncountedTerminatedPodsv1 } from './UncountedTerminatedPodsv1.js';
...
export interface JobStatusv1 {
   ...
   */
  conditions?: Array<JobConditionv1>;
  /**
   ...
   */
  uncountedTerminatedPods?: UncountedTerminatedPodsv1;
}
