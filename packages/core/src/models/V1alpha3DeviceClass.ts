...
import { V1alpha3DeviceClassSpec } from './V1alpha3DeviceClassSpec.js';
import { K8sApp } from '../K8sApp.js';
import { ApiObject } from '../ApiObject.js';

export interface V1alpha3DeviceClassArgs {
  readonly metadata?: V1ObjectMeta;
  readonly spec: V1alpha3DeviceClassSpec;
}
 ...
 */
export class V1alpha3DeviceClass extends ApiObject {
  /**
  ...
  constructor(app: K8sApp, name: string, args: V1alpha3DeviceClassArgs) {
    super();
