...
import { ResourceSliceSpecv1alpha3 } from './ResourceSliceSpecv1alpha3.js';
import { K8sApp } from '../K8sApp.js';
import { ApiObject } from '../ApiObject.js';

export interface ResourceSlicev1alpha3Args {
  readonly metadata?: ObjectMetav1;
  readonly spec: ResourceSliceSpecv1alpha3;
}
 ...
 */
export class ResourceSlicev1alpha3 extends ApiObject {
  /**
  ...
  constructor(app: K8sApp, name: string, args: ResourceSlicev1alpha3Args) {
    super();
