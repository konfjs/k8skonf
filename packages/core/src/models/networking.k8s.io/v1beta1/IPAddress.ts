import { IPAddressSpec } from '../../networking/v1beta1/IPAddressSpec';
 ...
 */
export class IPAddress extends ApiObject {
  /**
  ...
  constructor(app: K8sApp, name: string, args: IPAddressArgs) {
