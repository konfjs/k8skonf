...
export interface ResourceClaimv1beta1Args {
 ...
 */
export class ResourceClaimv1beta1 extends NamespacedApiObject {
  /**
  ...
  constructor(app: K8sApp, name: string, args: ResourceClaimv1beta1Args) {
    super();
