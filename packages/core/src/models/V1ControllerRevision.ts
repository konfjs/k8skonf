...
export interface V1ControllerRevisionArgs {
  readonly data?: any;
 ...
 */
export class V1ControllerRevision extends NamespacedApiObject {
  /**
  ...
  constructor(app: K8sApp, name: string, args: V1ControllerRevisionArgs) {
    super();
    this.data = args.data;
