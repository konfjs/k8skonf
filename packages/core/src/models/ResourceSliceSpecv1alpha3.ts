import { Devicev1alpha3 } from './Devicev1alpha3.js';
import { NodeSelectorv1 } from './NodeSelectorv1.js';
import { ResourcePoolv1alpha3 } from './ResourcePoolv1alpha3.js';

/**
 * ResourceSliceSpec contains the information published by the driver in one ResourceSlice.
 */
export interface ResourceSliceSpecv1alpha3 {
  /**
